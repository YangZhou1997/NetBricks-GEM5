...
maxmem = list(map(lambda x: int(x * 1024 * 1024), [17.19140625, 50.9765625, 68.234375, 13.2265625, 360.2109375, 43.828125]))

pgszs = [[4 * 1024, 1 * 1024 * 1024, 16 * 1024 * 1024], [128 * 1024, 2 * 1024 * 1024, 64 * 1024 * 1024], [2 * 1024 * 1024, 32 * 1024 * 1024, 128 * 1024 * 1024]]
